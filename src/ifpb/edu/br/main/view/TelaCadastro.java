    ...
    public void configurar() {
        ...
        btnCadastrar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (nome.isEmpty() || matricula.isEmpty() || disciplina.isEmpty() || senha.isEmpty()) { //Verifica se os campos estão preenchidos
        ...
        btnAdicionar.addActionListener(e -> {
            String nome = getTextNome().trim();
            String disciplina = getTextDisciplina().trim();
            areaDescricao.append("Disciplina(s): " + disciplina);
